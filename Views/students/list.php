...
$data = $studentController->getStudentListData();
$allStudents = $studentController->getAll();
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        <div class="d-flex align-items-center">
                            ...
                            <select name="limit" class="form-select form-select-sm" style="width: auto;" onchange="changePageLimit(this.value)">
                            ...
                            <ul class="pagination pagination-sm mb-0">
                                <li class="page-item <?= $currentPage <= 1 ? 'disabled' : '' ?>">
                                    <?php if ($currentPage > 1): ?>
                                        <a class="page-link" href="?page=<?= $currentPage - 1 ?>&limit=<?= $perPage ?>&search=<?= urlencode($search) ?>">Previous</a>
                                    <?php else: ?>
                                ...
                                <?php for ($i = 1; $i <= $totalPagesCount; $i++): ?>
                                    <li class="page-item <?= $i === $currentPage ? 'active' : '' ?>">
                                        <a class="page-link" href="?page=<?= $i ?>&limit=<?= $perPage ?>&search=<?= urlencode($search) ?>"><?= $i ?></a>
                                    </li>
                                <?php endfor; ?>
                                <li class="page-item <?= $currentPage >= $totalPagesCount ? 'disabled' : '' ?>">
                                    <?php if ($currentPage < $totalPagesCount): ?>
                                        <a class="page-link" href="?page=<?= $currentPage + 1 ?>&limit=<?= $perPage ?>&search=<?= urlencode($search) ?>">Next</a>
                                    <?php else: ?>
